...
export function requestProductionBmr(token: string, id: string): Promise<ProductionBatchItem> {
  return request<ProductionBatchItem>(`/api/production/batches/${id}/request-bmr`, 'POST', { token })
}
