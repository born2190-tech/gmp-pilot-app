...
PERMISSIONS: list[tuple[str, str]] = [
    ...
    ("RECEIVE_FINISHED_GOODS", "Receive finished goods from workshop into FG warehouse (СОП-205) — склад ГП"),
]

ROLE_PERMISSION_CODES: dict[str, list[str]] = {
    "WAREHOUSE_OPERATOR": ["VIEW_WAREHOUSE", "CREATE_RECEIPT", "POST_RECEIPT", "VIEW_MASTER_DATA", "COUNT_INVENTORY", "RECEIVE_FINISHED_GOODS"],
    "WAREHOUSE_MANAGER": ["VIEW_WAREHOUSE", "CREATE_RECEIPT", "POST_RECEIPT", "VIEW_MASTER_DATA", "VIEW_AUDIT", "COUNT_INVENTORY", "RECEIVE_FINISHED_GOODS"],
