...
ROLE_PERMISSION_CODES: dict[str, list[str]] = {
    ...
    "QC_ANALYST": ["VIEW_MASTER_DATA", "VIEW_QC", "ENTER_QC_RESULT"],
    "QA_MANAGER": ["VIEW_MASTER_DATA", "VIEW_QA", "QA_DECISION", "VIEW_AUDIT"],
    "HEAD_QA": ["VIEW_MASTER_DATA", "VIEW_QA", "QA_DECISION", "VIEW_AUDIT"],
    "HEAD_QC": ["VIEW_MASTER_DATA", "VIEW_QC", "ENTER_QC_RESULT", "VIEW_AUDIT"],
