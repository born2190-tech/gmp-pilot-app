...
ROLE_PERMISSION_CODES: dict[str, list[str]] = {
    ...
    "QC_ANALYST": ["VIEW_MASTER_DATA", "VIEW_QC", "ENTER_QC_RESULT", "UPLOAD_QC_SCAN", "VERIFY_INVENTORY_COUNT", "VIEW_PRODUCTION"],
    "QA_MANAGER": ["VIEW_MASTER_DATA", "VIEW_QA", "QA_DECISION", "VERIFY_QC_SCAN", "VIEW_AUDIT", "VERIFY_INVENTORY_COUNT", "POST_INVENTORY_COUNT", "VIEW_PRODUCTION"],
    "HEAD_QA": ["VIEW_MASTER_DATA", "VIEW_QA", "QA_DECISION", "VERIFY_QC_SCAN", "VIEW_AUDIT", "VERIFY_INVENTORY_COUNT", "POST_INVENTORY_COUNT", "VIEW_PRODUCTION"],
    "HEAD_QC": ["VIEW_MASTER_DATA", "VIEW_QC", "ENTER_QC_RESULT", "UPLOAD_QC_SCAN", "MANAGE_SPECIFICATIONS", "VERIFY_INVENTORY_COUNT", "EQUIPMENT_MANAGE", "VIEW_PRODUCTION"],
